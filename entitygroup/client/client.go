...
func (c *Client) GetToken(
	...
	endpointURL := core.EncodeURL(baseURL+"/entityGroup/%v/token", entityGroupID)
...
func (c *Client) AddEntities(
	...
	endpointURL := core.EncodeURL(baseURL+"/entityGroup/%v/addEntities", entityGroupID)
...
func (c *Client) RemoveEntities(
	...
	endpointURL := core.EncodeURL(baseURL+"/entityGroup/%v/removeEntities", entityGroupID)
