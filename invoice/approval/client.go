...
func (c *Client) AddApprover(
	...
	endpointURL := core.EncodeURL(baseURL+"/invoice/%v/add-approver", invoiceID)
...
func (c *Client) Approve(
	...
	endpointURL := core.EncodeURL(baseURL+"/invoice/%v/approve", invoiceID)
...
func (c *Client) Reject(
	...
	endpointURL := core.EncodeURL(baseURL+"/invoice/%v/reject", invoiceID)
