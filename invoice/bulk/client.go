...
func (c *Client) Update(
	ctx context.Context,
	request *invoice.BulkInvoiceUpdateRequest,
	opts ...option.RequestOption,
) (*mercoafinancego.BulkInvoiceUpdateResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *mercoafinancego.BulkInvoiceUpdateResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Approve(
	ctx context.Context,
	request *invoice.BulkInvoiceApprovalRequest,
	opts ...option.RequestOption,
) (*mercoafinancego.BulkInvoiceApprovalResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	endpointURL := baseURL + "/invoices/approve"
	queryParams, err := internal.QueryValues(request)
	if err != nil {
		return nil, err
	}
	...
	var response *mercoafinancego.BulkInvoiceApprovalResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Download(
	ctx context.Context,
	request *invoice.DownloadBulkInvoicesRequest,
	opts ...option.RequestOption,
) (*mercoafinancego.BulkDownloadResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	endpointURL := baseURL + "/invoices/download"
	queryParams, err := internal.QueryValues(request)
	if err != nil {
		return nil, err
	}
	...
	var response *mercoafinancego.BulkDownloadResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
