...
func (c *Client) GetNextAction(
	...
	endpointURL := core.EncodeURL(baseURL+"/invoice/%v/collection/next-action", invoiceID)
...
func (c *Client) ApproveNextAction(
	...
	endpointURL := core.EncodeURL(baseURL+"/invoice/%v/collection/next-action/approve", invoiceID)
