...
func (c *Client) Ocr(
	...
	errorDecoder := func(statusCode int, body io.Reader) error {
		...
		case "OcrFailure":
			value := new(mercoafinancego.OcrFailure)
	...
	var response *mercoafinancego.OcrResponse
...
func (c *Client) RunAsyncOcr(
	...
	var response *mercoafinancego.OcrAsyncResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
...
func (c *Client) GetAsyncOcr(
	ctx context.Context,
	jobID string,
	opts ...option.RequestOption,
) (*mercoafinancego.OcrJobResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := core.EncodeURL(baseURL+"/ocr-async/%v", jobID)
	...
	var response *mercoafinancego.OcrJobResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
