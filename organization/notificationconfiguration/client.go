...
func (c *Client) GetAll(
...
) ([]*mercoafinancego.NotificationConfigurationResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := baseURL + "/organization/notification-configurations"
	...
	var response []*mercoafinancego.NotificationConfigurationResponse
...
func (c *Client) Get(
	...
	endpointURL := core.EncodeURL(baseURL+"/organization/notification-configuration/%v", notificationType)
...
func (c *Client) Update(
	ctx context.Context,
	notificationType mercoafinancego.NotificationType,
	request *mercoafinancego.NotificationConfigurationRequest,
	opts ...option.RequestOption,
) (*mercoafinancego.NotificationConfigurationResponse, error) {
	options := core.NewRequestOptions(opts...)
