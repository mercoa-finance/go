...
func (c *Client) GetAll(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/invoice-template/%v/documents",
		invoiceTemplateID,
	)
...
func (c *Client) Upload(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/invoice-template/%v/document",
		invoiceTemplateID,
	)
	headers := internal.MergeHeaders(
		c.header.Clone(),
...
func (c *Client) GenerateInvoicePdf(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/invoice-template/%v/pdf/generate",
		invoiceTemplateID,
	)
	headers := internal.MergeHeaders(
		c.header.Clone(),
...
func (c *Client) GenerateCheckPdf(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/invoice-template/%v/check/generate",
		invoiceTemplateID,
	)
	headers := internal.MergeHeaders(
		c.header.Clone(),
...
func (c *Client) GetSourceEmail(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/invoice-template/%v/source-email",
		invoiceTemplateID,
	)
	headers := internal.MergeHeaders(
		c.header.Clone(),
