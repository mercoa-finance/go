...
func (c *Client) Find(
	ctx context.Context,
	request *mercoafinancego.FindPaymentMethodsRequest,
	opts ...option.RequestOption,
) (*mercoafinancego.PaymentMethodWithEntityFindResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := baseURL + "/paymentMethods"
	...
	var response *mercoafinancego.PaymentMethodWithEntityFindResponse
