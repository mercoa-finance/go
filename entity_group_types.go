...
type EntityGroupAddEntitiesRequest struct {
	...
	FilterRoles []string `json:"filterRoles,omitempty" url:"filterRoles,omitempty"`
...
func (e *EntityGroupAddEntitiesRequest) GetFilterRoles() []string {
	if e == nil {
		return nil
	}
	return e.FilterRoles
}
...
func (e *EntityGroupUserRequest) GetRoles() []string {
	if e == nil {
		return nil
	}
	return e.Roles
...
type EntityGroupUserSyncRequest struct {
	...
	CopyUsersFrom *EntityID `json:"copyUsersFrom,omitempty" url:"copyUsersFrom,omitempty"`
	// List of roles to filter users by. If not provided, all users will be copied. If provided, only users with the provided roles will be copied.
	FilterRoles []string `json:"filterRoles,omitempty" url:"filterRoles,omitempty"`
	// If true, users will be added to entities if they are not found in the copyUsersFrom entity. Default is true.
	AddUsers *bool `json:"addUsers,omitempty" url:"addUsers,omitempty"`
	// If true, users will be removed from entities if they are not found in the copyUsersFrom entity. Default is false.
	RemoveUsers *bool `json:"removeUsers,omitempty" url:"removeUsers,omitempty"`

	extraProperties map[string]interface{}
	rawJSON         json.RawMessage
}

func (e *EntityGroupUserSyncRequest) GetCopyUsersFrom() *EntityID {
	if e == nil {
		return nil
	}
	return e.CopyUsersFrom
...
func (e *EntityGroupUserSyncRequest) GetFilterRoles() []string {
	if e == nil {
		return nil
	}
	return e.FilterRoles
...
func (e *EntityGroupUserSyncRequest) GetAddUsers() *bool {
	if e == nil {
		return nil
	}
	return e.AddUsers
...
func (e *EntityGroupUserSyncRequest) GetRemoveUsers() *bool {
	if e == nil {
		return nil
	}
	return e.RemoveUsers
}

func (e *EntityGroupUserSyncRequest) GetExtraProperties() map[string]interface{} {
	return e.extraProperties
}

func (e *EntityGroupUserSyncRequest) UnmarshalJSON(data []byte) error {
	type unmarshaler EntityGroupUserSyncRequest
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*e = EntityGroupUserSyncRequest(value)
	extraProperties, err := internal.ExtractExtraProperties(data, *e)
	if err != nil {
		return err
	}
...
func (e *EntityGroupUserSyncRequest) String() string {
	if len(e.rawJSON) > 0 {
		if value, err := internal.StringifyJSON(e.rawJSON); err == nil {
			return value
		}
