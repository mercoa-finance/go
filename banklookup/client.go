...
func (c *Client) Find(
	ctx context.Context,
	request *mercoafinancego.BankLookupRequest,
	opts ...option.RequestOption,
) (*mercoafinancego.BankLookupResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := baseURL + "/bankLookup"
	...
	var response *mercoafinancego.BankLookupResponse
