...
func (c *Client) Find(
	ctx context.Context,
	request *mercoafinancego.FindTransactionsRequest,
	opts ...option.RequestOption,
) (*mercoafinancego.FindTransactionsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *mercoafinancego.FindTransactionsResponse
...
func (c *Client) Get(
	ctx context.Context,
	transactionID mercoafinancego.TransactionID,
	opts ...option.RequestOption,
) (*mercoafinancego.TransactionResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *mercoafinancego.TransactionResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Download(
	ctx context.Context,
	request *mercoafinancego.DownloadTransactionsRequest,
	opts ...option.RequestOption,
	...
	endpointURL := baseURL + "/transactions/download"
	queryParams, err := internal.QueryValues(request)
	if err != nil {
		return nil, err
	}
