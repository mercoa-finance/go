...
func (c *Client) GetAll(
	...
	endpointURL := core.EncodeURL(baseURL+"/entity/%v/notification-policies", entityID)
	...
	var response []*mercoafinancego.NotificationPolicyResponse
...
func (c *Client) Get(
	...
	endpointURL := core.EncodeURL(
		baseURL+"/entity/%v/notification-policy/%v",
		entityID,
		notificationType,
	)
