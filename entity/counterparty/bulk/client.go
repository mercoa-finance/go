...
func (c *Client) DownloadPayees(
	ctx context.Context,
	// Entity ID or Entity ForeignID
	entityID mercoafinancego.EntityID,
	request *counterparty.DownloadBulkPayeesRequest,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/entity/%v/counterparties/payees/download",
		entityID,
	)
...
func (c *Client) DownloadPayors(
	ctx context.Context,
	// Entity ID or Entity ForeignID
	entityID mercoafinancego.EntityID,
	request *counterparty.DownloadBulkPayorsRequest,
	opts ...option.RequestOption,
) (*mercoafinancego.BulkDownloadResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/entity/%v/counterparties/payors/download",
		entityID,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
