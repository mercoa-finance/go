...
func (c *Client) FindPayees(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/entity/%v/counterparties/payees",
		entityID,
	)
...
func (c *Client) FindPayors(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/entity/%v/counterparties/payors",
		entityID,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
