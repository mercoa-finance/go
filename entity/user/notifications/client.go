...
func (c *Client) Find(
...
) (*mercoafinancego.FindNotificationResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := core.EncodeURL(
		baseURL+"/entity/%v/user/%v/notifications",
		entityID,
		userID,
	)
	...
	var response *mercoafinancego.FindNotificationResponse
...
func (c *Client) Get(
	...
	opts ...option.RequestOption,
) (*mercoafinancego.NotificationResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := core.EncodeURL(
		baseURL+"/entity/%v/user/%v/notification/%v",
		entityID,
		userID,
		notificationID,
	)
	...
	var response *mercoafinancego.NotificationResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
