...
import (
	...
	user "github.com/mercoa-finance/go/entity/user"
	notificationpolicy "github.com/mercoa-finance/go/entity/user/notificationpolicy"
	notifications "github.com/mercoa-finance/go/entity/user/notifications"
...
func (c *Client) Find(
...
) (*mercoafinancego.FindEntityUserResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := core.EncodeURL(baseURL+"/entity/%v/users", entityID)
	...
	var response *mercoafinancego.FindEntityUserResponse
...
func (c *Client) Create(
	...
	endpointURL := core.EncodeURL(baseURL+"/entity/%v/user", entityID)
	...
	var response *mercoafinancego.EntityUserResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
