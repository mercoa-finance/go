...
func (c *Client) CompleteMicroDeposits(
	...
	// Payment Method ID or Payment Method ForeignID
	paymentMethodID mercoafinancego.PaymentMethodID,
	request *paymentmethod.CompleteMicroDepositsRequest,
	opts ...option.RequestOption,
) (*mercoafinancego.PaymentMethodResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
...
func (c *Client) GetAccelerationFunds(
	ctx context.Context,
	// Entity ID or Entity ForeignID
	entityID mercoafinancego.EntityID,
	// Payment Method ID or Payment Method ForeignID
	paymentMethodID mercoafinancego.PaymentMethodID,
	opts ...option.RequestOption,
) (*mercoafinancego.AccelerationFundsResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/entity/%v/paymentMethod/%v/acceleration-funds",
		entityID,
		paymentMethodID,
	)
	headers := internal.MergeHeaders(
	...
	var response *mercoafinancego.AccelerationFundsResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) AddAccelerationFunds(
	ctx context.Context,
	// Entity ID or Entity ForeignID
	entityID mercoafinancego.EntityID,
	// Payment Method ID or Payment Method ForeignID
	paymentMethodID mercoafinancego.PaymentMethodID,
	request *paymentmethod.AddAccelerationFundsRequest,
	opts ...option.RequestOption,
) error {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/entity/%v/paymentMethod/%v/add-acceleration-funds",
		entityID,
		paymentMethodID,
	)
	headers := internal.MergeHeaders(
...
func (c *Client) RemoveAccelerationFunds(
	ctx context.Context,
	// Entity ID or Entity ForeignID
	entityID mercoafinancego.EntityID,
	// Payment Method ID or Payment Method ForeignID
	paymentMethodID mercoafinancego.PaymentMethodID,
	request *paymentmethod.RemoveAccelerationFundsRequest,
	opts ...option.RequestOption,
) error {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/entity/%v/paymentMethod/%v/remove-acceleration-funds",
		entityID,
		paymentMethodID,
	)
	headers := internal.MergeHeaders(
